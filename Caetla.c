...
void loop(){
	...
	if ( dbg >= 1 ){
		...
		// Example of 
		// Caetla commands start by sending byte/char sequence 'C','L'		
		for ( int i = 0 ; i < 100 ; i++ ){

			// Analogous to the Xplorer Command( byteA, byteB )
			// but caetla requires ack routines here
		...
		// That's it, not doing anything fancy like the Xplorer code!
